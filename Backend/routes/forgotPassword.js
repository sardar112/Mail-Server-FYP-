...
router.post('/', (async(req, res) => {
    ...
    let transporter=nodemailer.createTransport({
        ...
        secure: false, 
        auth: {
            user:"autoreplygenerator8@gmail.com",
            pass:"#alpha12345"
    ...
    res.json({ error: false,message: "Link has been sent to your recovery email for reset passwword . Don't Forget to Check your Email in Spam" });
...
try{
   ...
   // console.log(decoded)
    ...
    res.json({ error: false,message :" Password Succesfully Updated." ,data: user})
}
